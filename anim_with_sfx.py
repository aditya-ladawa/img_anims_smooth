...
class Animations:
    ...
    def render_gif(self, filename, fps=60):
        ...
        if has_audio:
            ...
            audio_filter = f"volume=0.15,afade=t=out:st={self.current_duration - 0.1:.2f}:d=0.2"
...
def process_images_with_random_fx(
    ...
    for img_file in image_files:
        ...
        output_name = f"{name}_{entry['animation']}.webm"
        func(img_path, duration=duration, sfx=sfx_path)
        anim.render_gif(output_name)
...
if __name__=="__main__":
    ...
    animations_simple_fx = [
        ...
        {"animation": "transparent_in",      "duration": 0.5, "sfx": "shimmer",     "function": anim.transparent_in},
